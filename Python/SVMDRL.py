...
for past in cores:
    for cv in cv1:
        arqm = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/RGBLabE' + '_' + str(cv) + '.tex', 'w')
        for e, esp in enumerate(['Italia', 'RedGlobe','Vitoria']):
            arqtp = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/RGBLabT_P' + '_' + str(cv) + '_' +  esp + '.tex', 'w')

            arqtse = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/RGBLabT_SE' + '_' + str(cv) + '_' +  esp + '.tex', 'w')

            arqta = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/RGBLabT_A' + '_' + str(cv) + '_' +  esp + '.tex', 'w')
            arqme = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/RGBLabT_ME' + '_' + str(cv) + '_' +  esp + '.tex', 'w')
...
for past in cores:
    for cv in cv1:
        ...
        arqm = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/RGBLabE' + '_' + str(cv) + '.tex', 'a+')
        ...
        for e, esp in enumerate(['Italia', 'RedGlobe','Vitoria']):
            ...
            arqtp = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/RGBLabT_P' + '_' + str(cv) + '_' +  esp + '.tex', 'a+')

            arqtse = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/RGBLabT_SE' + '_' + str(cv) + '_' +  esp + '.tex', 'a+')

            arqta = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/RGBLabT_A' + '_' + str(cv) + '_' +  esp + '.tex', 'a+')
            ...
            arqme = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/RGBLabT_ME' + '_' + str(cv) + '_' +  esp + '.tex', 'a+')
