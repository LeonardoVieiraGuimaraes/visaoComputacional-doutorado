...
for past in cores:
    for radius in raios:
        for cv in cv1:
            arqm = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/MLP/LBPRGBLabE' + '_' + str(cv) + '_' + str(radius) + '.tex', 'w')
            for e, esp in enumerate(['Italia', 'RedGlobe','Vitoria']):
                 arqtp = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/MLP/LBPRGBLabT_P' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'w')
                 arqtse = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/MLP/LBPRGBLabT_SE' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'w')
                 arqta = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/MLP/LBPRGBLabT_A' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'w')
                 arqme = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/MLP/LBPRGBLabT_ME' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'w')
...
for past in cores:
    for radius in raios:
        ...
        arqm = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/MLP/LBPRGBLabE' + '_' + str(cv) + '_' + str(radius) + '.tex', 'a+')
        ...
        for e, esp in enumerate(['Italia', 'RedGlobe','Vitoria']):
            ...
            arqtp = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/MLP/LBPRGBLabT_P' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'a+')
            arqtse = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/MLP/LBPRGBLabT_SE' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'a+')
            arqta = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/MLP/LBPRGBLabT_A' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'a+')
            ...
            arqme = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/MLP/LBPRGBLabT_ME' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'a+')
