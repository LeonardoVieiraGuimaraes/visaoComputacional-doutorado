...
for past in cores:
    for radius in raios:
        for cv in cv1:
            arqm = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/LBPRGBLabE' + '_' + str(cv) + '_' + str(radius) + '.tex', 'w')
            for e, esp in enumerate(['Italia', 'RedGlobe','Vitoria']):
                arqtp = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/LBPRGBLabT_P' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'w')
                arqtse = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/LBPRGBLabT_SE' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'w')
                arqta = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/LBPRGBLabT_A' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'w')
                arqme = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/LBPRGBLabT_ME' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'w')
...
for past in cores:
    for radius in raios:
        ...
        arqm = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/LBPRGBLabE' + '_' + str(cv) + '_' + str(radius) + '.tex', 'a+')
        ...
        for e, esp in enumerate(['Italia', 'RedGlobe','Vitoria']):
            ...
            arqtp = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/LBPRGBLabT_P' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'a+')
            arqtse = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/LBPRGBLabT_SE' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'a+')
            arqta = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/LBPRGBLabT_A' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'a+')

            arqtp.write('LBP ' + str(radius) + ' ' + past + '     &     ' + str(np.around(PR1[e][0],decimals = 2))  + '     &    ' +  str(np.around(PR1[e][1],decimals = 2))  + '    &    ' + str(np.around(PR1[e][2], decimals = 2))  + '     &   '  + str(np.around(PR1[e][3],decimals = 2))  + '     &    '  + str(np.around(PR1[e][4],decimals = 2))  + ' \\\ \n')

            arqtse.write('LBP ' + str(radius) + ' ' + past +  '     &    ' + str(np.around(TPR1[e][0],decimals = 2))  + '     &     ' + str(np.around(TPR1[e][1],decimals = 2))  + '     &    ' + str(np.around(TPR1[e][2],decimals = 2))  + '     &    ' + str(np.around(TPR1[e][3],decimals = 2))  + '     &    ' + str(np.around(TPR1[e][4],decimals = 2))  + '     &    ' +  str(np.around(TNR1[e][0],decimals = 2))  + '    &       ' + str(np.around(TNR1[e][1], decimals = 2))  + '   &   ' + str(np.around(TNR1[e][2],decimals=2))  + '   &   ' + str(np.around(TNR1[e][3],decimals = 2))  + '    &       ' + str(np.around(TNR1[e][4],decimals = 2)) + ' \\\ \n')

            arqta.write('LBP ' + str(radius) + ' ' + past + '     &     ' + str(np.around(ACG[e],decimals = 2)) + ' \\\ \n')

            arqme = open('C:/Users/Leonardo/Desktop/Dissertacao/Resultados/SVM/LBPRGBLabT_ME' + '_' + str(cv) + '_' + str(radius) + '_' +  esp + '.tex', 'a+')

            arqme.write('LBP ' + str(radius) + ' ' + past +  '     &    '+ ' Precisão ' + str(np.around(np.mean(PR1[e]),decimals = 2)) + ' Sensibilidade ' + str(np.around(np.mean(TPR1[e]),decimals = 2)) + ' Especificidade ' + str(np.around(np.mean(TNR1[e]),decimals = 2)) + ' Acurácia ' + str(np.around(ACG1[e],decimals = 2)) + '\n')
